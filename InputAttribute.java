...
public class InputAttribute {
	...
	public static void main(String[] args) {
		...
		System.out.println(driver.findElement(By.xpath("//form[@id='j_idt88']/div[3]/div[1]")).isEnabled());

		// Clear the text by using clear method
		driver.findElement(By.xpath("//input[@value='Can you clear me, please?']")).clear();

		// Get the text by using getText method
		...
		System.out.println(driver.findElement(By.xpath("//span[@class='ui-float-label']//input")).getLocation());
	}
}
